...
let funcionario = parseInt(25);
let horas_trabalhadas = parseInt(100);
let valor_por_hora = parseFloat(5.50);   

let salario = ( horas_trabalhadas * valor_por_hora);


console.log(`Numero do Funcionário: ${funcionario}  \nSalário do funcionário:R$ ${salario.toFixed(2)}`)